 ...
 * <ul>
 *   <li>{@link org.sintef.thingml.impl.EnumerationLiteralImpl#getEnum <em>Enum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationLiteralImpl extends AnnotatedElementImpl implements EnumerationLiteral {
	...
	public NotificationChain basicSetEnum(Enumeration newEnum, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newEnum, ThingmlPackage.ENUMERATION_LITERAL__ENUM, msgs);
		return msgs;
	}
	...
	public void setEnum(Enumeration newEnum) {
		if (newEnum != eInternalContainer() || (eContainerFeatureID() != ThingmlPackage.ENUMERATION_LITERAL__ENUM && newEnum != null)) {
			...
			if (newEnum != null)
				msgs = ((InternalEObject)newEnum).eInverseAdd(this, ThingmlPackage.ENUMERATION__LITERALS, Enumeration.class, msgs);
			msgs = basicSetEnum(newEnum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingmlPackage.ENUMERATION_LITERAL__ENUM, newEnum, newEnum));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ThingmlPackage.ENUMERATION_LITERAL__ENUM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ThingmlPackage.ENUMERATION_LITERAL__ENUM:
				return eInternalContainer().eInverseRemove(this, ThingmlPackage.ENUMERATION__LITERALS, Enumeration.class, msgs);
		}

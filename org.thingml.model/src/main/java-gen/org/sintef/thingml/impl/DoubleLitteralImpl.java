 ...
 * <ul>
 *   <li>{@link org.sintef.thingml.impl.DoubleLitteralImpl#getDoubleValue <em>Double Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleLitteralImpl extends LitteralImpl implements DoubleLitteral {
	...
	protected EClass eStaticClass() {
		return ThingmlPackage.Literals.DOUBLE_LITTERAL;
	}
	...
	public void setDoubleValue(double newDoubleValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThingmlPackage.DOUBLE_LITTERAL__DOUBLE_VALUE, oldDoubleValue, doubleValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThingmlPackage.DOUBLE_LITTERAL__DOUBLE_VALUE:

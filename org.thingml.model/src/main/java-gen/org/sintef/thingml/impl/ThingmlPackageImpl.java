...
public class ThingmlPackageImpl extends EPackageImpl implements ThingmlPackage {
	 ...
	 * @generated
	 */
	public EAttribute getThingMLModel_Uri() {
		return (EAttribute)thingMLModelEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getThingMLModel___imports_cache() {
		return (EReference)thingMLModelEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getThingMLModel___imports_parent() {
		return (EReference)thingMLModelEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getConfiguration_Includes() {
	 ...
	 * @generated
	 */
	public EReference getConnector_Server() {
	...
	public void createPackageContents() {
		...
		createEAttribute(thingMLModelEClass, THING_ML_MODEL__URI);
		createEReference(thingMLModelEClass, THING_ML_MODEL__IMPORTS_CACHE);
		createEReference(thingMLModelEClass, THING_ML_MODEL__IMPORTS_PARENT);
		...
		createEReference(configurationEClass, CONFIGURATION__INCLUDES);
		...
		createEReference(connectorEClass, CONNECTOR__SERVER);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getThingMLModel_Uri(), ecorePackage.getEString(), "uri", null, 0, 1, ThingMLModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThingMLModel___imports_cache(), this.getThingMLModel(), null, "__imports_cache", null, 0, -1, ThingMLModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThingMLModel___imports_parent(), this.getThingMLModel(), null, "__imports_parent", null, 0, 1, ThingMLModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getVariableAssignment_Property(), this.getProperty(), null, "property", null, 1, 1, VariableAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConfiguration_Includes(), this.getConfiguration(), null, "includes", null, 0, -1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConnector_Server(), this.getInstance(), null, "server", null, 1, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConnector_Client(), this.getInstance(), null, "client", null, 1, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

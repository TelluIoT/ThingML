...
public class ThingmlAdapterFactory extends AdapterFactoryImpl {
	...
	protected ThingmlSwitch<Adapter> modelSwitch =
		new ThingmlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseComplexStream(ComplexStream object) {
				return createComplexStreamAdapter();
			}
			@Override
			public Adapter caseMergedStreams(MergedStreams object) {
				return createMergedStreamsAdapter();
			}
			@Override
			public Adapter caseJoinedStreams(JoinedStreams object) {
				return createJoinedStreamsAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseOperatorParameter(OperatorParameter object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sintef.thingml.ComplexStream <em>Complex Stream</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createComplexStreamAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.sintef.thingml.MergedStreams <em>Merged Streams</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMergedStreamsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.sintef.thingml.JoinedStreams <em>Joined Streams</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJoinedStreamsAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.sintef.thingml.OperatorParameter <em>Operator Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

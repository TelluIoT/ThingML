...
public class SecuredSensAppHelper {
	...
	public static void main(String[] args) throws Exception {
		System.setProperty("javax.net.ssl.trustStore", "C:\\Program Files\\Java\\jdk1.6.0_29\\jre\\lib\\security\\cacerts");
		Authenticator.setDefault(new Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {          
		        return new PasswordAuthentication("sensappuser", "sensapp".toCharArray());
		    }
		});
		...
		String status = SensAppHelper.registerSensor(regURL, "testpl",
				"just a test", "raw", "Numerical");
		String data = SensAppHelper.pushData(pushURL, "{\"tags\":{\"owner\":\"Franck Fleurey\",\"license\":\"LGPL\"}}");

...
<html lang="en">
	...
	<body>
		...
		<script type="text/javascript" src="../../lib/state.js" target="state"></script>
		
		<!-- script to wire the core player to the web page -->
		<script>
			/* global $, state */      
			$(document).ready(function() {
				var logger = { log: function(text) { $("#log").prepend(text + "<br/>"); } };
				
				/* create the state machine model elements */
				var model = new state.StateMachine("model").setLogger(logger);
				...
				$("button").click(function(button) { state.evaluate(model, instance, button.target.textContent); });
			});
		</script>
	</body>
</html>
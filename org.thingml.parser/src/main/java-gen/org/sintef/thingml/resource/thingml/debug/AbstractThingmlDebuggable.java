...
public abstract class AbstractThingmlDebuggable {
	...
	public void startEventSocket(int eventPort) {
		try {
			...
			org.sintef.thingml.resource.thingml.mopp.ThingmlPlugin.logError("Can't create socket connection while launching.", e);
		}
	}
	...
	public void stopEventSocket() {
		try {
			...
			org.sintef.thingml.resource.thingml.mopp.ThingmlPlugin.logError("Exception while closing socket.", e);
		}
	}

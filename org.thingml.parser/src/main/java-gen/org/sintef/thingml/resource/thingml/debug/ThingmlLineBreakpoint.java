...
public class ThingmlLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.sintef.thingml.resource.thingml.debug.lineBreakpoint.marker";
	
	public ThingmlLineBreakpoint() {
		super();
	}
	
	public ThingmlLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.sintef.thingml.resource.thingml.debug.ThingmlDebugTarget target) {
		try {
	...
	public void remove(org.sintef.thingml.resource.thingml.debug.ThingmlDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);

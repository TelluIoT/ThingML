...
public class ThingmlT_HISTORYTokenResolver implements org.sintef.thingml.resource.thingml.IThingmlTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.sintef.thingml.resource.thingml.IThingmlTokenResolveResult result) {
		...
		result.setResolvedToken(lexem.equals("history"));
	}

...
public class OperatorCallParametersReferenceResolver implements org.sintef.thingml.resource.thingml.IThingmlReferenceResolver<org.sintef.thingml.OperatorCall, org.sintef.thingml.ReceiveMessage> {
	...
	public void resolve(String identifier, org.sintef.thingml.OperatorCall container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.sintef.thingml.resource.thingml.IThingmlReferenceResolveResult<org.sintef.thingml.ReceiveMessage> result) {
		...
		for(ReceiveMessage r : eventSources) {
			if(r.getName() != null) {
				if (resolveFuzzy && r.getName().startsWith(identifier)) {
					result.addMapping(r.getName(), r);
				} else if(!resolveFuzzy && r.getName().equals(identifier)) {
					result.addMapping(r.getName(), r);
				}
			}
		}
	...
	public String deResolve(org.sintef.thingml.ReceiveMessage element, org.sintef.thingml.OperatorCall container, org.eclipse.emf.ecore.EReference reference) {

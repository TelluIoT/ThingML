...
public class AbstractThingmlInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof org.sintef.thingml.MergedStreams) {
			result = interprete_org_sintef_thingml_MergedStreams((org.sintef.thingml.MergedStreams) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof org.sintef.thingml.JoinedStreams) {
			result = interprete_org_sintef_thingml_JoinedStreams((org.sintef.thingml.JoinedStreams) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof org.sintef.thingml.ComplexStream) {
			result = interprete_org_sintef_thingml_ComplexStream((org.sintef.thingml.ComplexStream) object, context);
		}
		if (result != null) {
			return result;
		}
		...
		if (object instanceof org.sintef.thingml.OperatorParameter) {
			result = interprete_org_sintef_thingml_OperatorParameter((org.sintef.thingml.OperatorParameter) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof org.sintef.thingml.SimpleStreamReference) {
			result = interprete_org_sintef_thingml_SimpleStreamReference((org.sintef.thingml.SimpleStreamReference) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_org_sintef_thingml_ComplexStream(org.sintef.thingml.ComplexStream complexStream, ContextType context) {
		return null;
	}
	
	public ResultType interprete_org_sintef_thingml_MergedStreams(org.sintef.thingml.MergedStreams mergedStreams, ContextType context) {
		return null;
	}
	
	public ResultType interprete_org_sintef_thingml_JoinedStreams(org.sintef.thingml.JoinedStreams joinedStreams, ContextType context) {
		return null;
	}
	...
	public ResultType interprete_org_sintef_thingml_OperatorParameter(org.sintef.thingml.OperatorParameter operatorParameter, ContextType context) {
		return null;
	}
	
	public ResultType interprete_org_sintef_thingml_SimpleStreamReference(org.sintef.thingml.SimpleStreamReference simpleStreamReference, ContextType context) {
		return null;
	}

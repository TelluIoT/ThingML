...
def testFile(fileName):
	...
	for (a,b) in results:
		...
		os.system("mvn clean package exec:java -Dexec.mainClass=\"org.thingml.cmd.Cmd\" -Dexec.args=\"scala org.thingml.samples/src/main/thingml/tests/_scala/"+fileName+".thingml\"")

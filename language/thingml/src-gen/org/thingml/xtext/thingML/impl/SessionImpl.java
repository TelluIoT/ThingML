 ...
 *   <li>{@link org.thingml.xtext.thingML.impl.SessionImpl#isHistory <em>History</em>}</li>
...
public class SessionImpl extends AnnotatedElementImpl implements Session
{
  ...
  public void setHistory(boolean newHistory)
  {
    ...
    history = newHistory;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.SESSION__HISTORY, oldHistory, history));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.SESSION__HISTORY:
        return isHistory();
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == Region.class)
    {
      ...
      {
        case ThingMLPackage.SESSION__INITIAL: return ThingMLPackage.REGION__INITIAL;
        case ThingMLPackage.SESSION__HISTORY: return ThingMLPackage.REGION__HISTORY;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == Region.class)
    {
      ...
      {
        case ThingMLPackage.REGION__INITIAL: return ThingMLPackage.SESSION__INITIAL;
        case ThingMLPackage.REGION__HISTORY: return ThingMLPackage.SESSION__HISTORY;
        default: return -1;
      }
    }
    if (baseClass == RegionOrSession.class)

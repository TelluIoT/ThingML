...
public interface Protocol extends AnnotatedElement
{
   ...
   * @see #setName(String)
   * @see org.thingml.xtext.thingML.ThingMLPackage#getProtocol_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.Protocol#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

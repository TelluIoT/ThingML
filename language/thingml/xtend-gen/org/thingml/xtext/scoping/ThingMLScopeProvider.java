                                                ...
                                                if (_equals_19) {
                                                  ...
                                                  if (_equals_20) {
                                                    ...
                                                    if (_equals_21) {
                                                      ...
                                                      EReference _parallelRegion_Initial = this.p.getParallelRegion_Initial();
                                                      boolean _equals_22 = Objects.equal(reference, _parallelRegion_Initial);
                                                      if (_equals_22) {
                                                        return this.scopeForParallelRegion_Initial(((ParallelRegion) context));
                                                      } else {

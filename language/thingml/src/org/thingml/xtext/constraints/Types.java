...
public class Types {
    ...
    static {
        ...
        final StringLiteral anyLit = factory.createStringLiteral();
        anyLit.setStringValue("Any");
        any.setValue(anyLit);
        ...
        final StringLiteral errorLit = factory.createStringLiteral();
        errorLit.setStringValue("Error");
        error.setValue(errorLit);
        ...
        final StringLiteral _voidLit = factory.createStringLiteral();
        _voidLit.setStringValue("Void");
        _void.setValue(_voidLit);
        ...
        final StringLiteral byteLit = factory.createStringLiteral();
        byteLit.setStringValue("Byte");
        _byte.setValue(byteLit);
        ...
        final StringLiteral integerLit = factory.createStringLiteral();
        integerLit.setStringValue("Integer");
        integer.setValue(integerLit);
        ...
        final StringLiteral boolLit = factory.createStringLiteral();
        boolLit.setStringValue("Boolean");
        bool.setValue(boolLit);
        ...
        final StringLiteral characterLit = factory.createStringLiteral();
        characterLit.setStringValue("Character");
        character.setValue(characterLit);
        ...
        final StringLiteral stringLit = factory.createStringLiteral();
        stringLit.setStringValue("String");
        string.setValue(stringLit);
        ...
        final StringLiteral realLit = factory.createStringLiteral();
        realLit.setStringValue("Real");
        real.setValue(realLit);
        ...
        final StringLiteral _objectLit = factory.createStringLiteral();
        _objectLit.setStringValue("Object");        
        _object.setValue(_objectLit);

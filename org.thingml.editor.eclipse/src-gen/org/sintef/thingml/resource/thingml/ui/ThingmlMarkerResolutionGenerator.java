...
public class ThingmlMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.sintef.thingml.resource.thingml.IThingmlOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.sintef.thingml.resource.thingml.mopp.ThingmlResource) {
					org.sintef.thingml.resource.thingml.mopp.ThingmlResource customResource = (org.sintef.thingml.resource.thingml.mopp.ThingmlResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.sintef.thingml.resource.thingml.IThingmlQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.sintef.thingml.resource.thingml.IThingmlQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.sintef.thingml.resource.thingml.ui.ThingmlUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.sintef.thingml.resource.thingml.ui.ThingmlUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.sintef.thingml.resource.thingml.IThingmlQuickFix> getQuickFixes(org.sintef.thingml.resource.thingml.IThingmlTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.sintef.thingml.resource.thingml.IThingmlQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {

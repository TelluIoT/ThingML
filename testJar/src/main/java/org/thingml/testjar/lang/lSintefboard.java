 ...
 * @author sintef
 */
public class lSintefboard extends TargetedLanguage {
    
    public lSintefboard() {
        compilerID = "sintefboard";
    }
    ...
    public Command compileTargeted(SimpleGeneratedTest t) {
        ...
        return new Command(execCmd, null, ".+", "Error at ecpp compilation", new File(t.genCodeDir, "/_" + compilerID + "/" + t.name + "_Cfg"));
    }

...
public class TransformGuard {
    ...
    private static ArrayIndex copyExpression(ArrayIndex guard) {
    ...
    private static BinaryExpression copyExpression(BinaryExpression guard) {
    ...
    private static UnaryExpression copyExpression(UnaryExpression guard) {
    ...
    private static EventReference copyExpression(EventReference guard) {
    ...
    private static ExpressionGroup copyExpression(ExpressionGroup guard) {
    ...
    private static PropertyReference copyExpression(PropertyReference guard) {
    ...
    private static IntegerLiteral copyExpression(IntegerLiteral guard) {
    ...
    private static DoubleLiteral copyExpression(DoubleLiteral guard) {
    ...
    private static StringLiteral copyExpression(StringLiteral guard) {
    ...
    private static BooleanLiteral copyExpression(BooleanLiteral guard) {
    ...
    private static EnumLiteralRef copyExpression(EnumLiteralRef guard) {
    ...
    private static ExternExpression copyExpression(ExternExpression guard) {
    ...
    private static FunctionCallExpression copyExpression(FunctionCallExpression guard) {

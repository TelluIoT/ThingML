...
object CGenerator {
  ...
  def compileAll(model: ThingMLModel): Hashtable[Thing, String] = {
    val result = new Hashtable[Thing, String]()
    model.allThings.foreach {
      t =>
        if (!t.getAnnotations.filter {
          a => a.getName == "c_code"
        }.isEmpty) {
...
case class ThingCGenerator(override val self: Thing) extends ThingMLCGenerator(self) {
  ...
  override def generateC(builder: StringBuilder) {
    builder append "/* Generated from ThingML : Do not edit this file */\n\n"

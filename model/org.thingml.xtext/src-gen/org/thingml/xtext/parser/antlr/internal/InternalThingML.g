...
@after {
	...
	(
		...
		{
			$current = $this_JoinSources_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_MergeSources_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_SimpleSource_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleViewSource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getViewSourceRule()); }
	iv_ruleViewSource=ruleViewSource
	{ $current=$iv_ruleViewSource.current; }
	EOF;

// Rule ViewSource
ruleViewSource returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_LengthWindow_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_TimeWindow_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleElmtProperty returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getElmtPropertyRule()); }
	iv_ruleElmtProperty=ruleElmtProperty
	{ $current=$iv_ruleElmtProperty.current; }
	EOF;

// Rule ElmtProperty
ruleElmtProperty returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_SimpleParamRef_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ArrayParamRef_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_LengthArray_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleJoinSources returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getJoinSourcesRule()); }
	iv_ruleJoinSources=ruleJoinSources
	{ $current=$iv_ruleJoinSources.current; }
	EOF;

// Rule JoinSources
ruleJoinSources returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMergeSources returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMergeSourcesRule()); }
	iv_ruleMergeSources=ruleMergeSources
	{ $current=$iv_ruleMergeSources.current; }
	EOF;

// Rule MergeSources
ruleMergeSources returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleLengthWindow returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLengthWindowRule()); }
	iv_ruleLengthWindow=ruleLengthWindow
	{ $current=$iv_ruleLengthWindow.current; }
	EOF;

// Rule LengthWindow
ruleLengthWindow returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSimpleParamRef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSimpleParamRefRule()); }
	iv_ruleSimpleParamRef=ruleSimpleParamRef
	{ $current=$iv_ruleSimpleParamRef.current; }
	EOF;

// Rule SimpleParamRef
ruleSimpleParamRef returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleArrayParamRef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getArrayParamRefRule()); }
	iv_ruleArrayParamRef=ruleArrayParamRef
	{ $current=$iv_ruleArrayParamRef.current; }
	EOF;

// Rule ArrayParamRef
ruleArrayParamRef returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleLengthArray returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLengthArrayRule()); }
	iv_ruleLengthArray=ruleLengthArray
	{ $current=$iv_ruleLengthArray.current; }
	EOF;

// Rule LengthArray
ruleLengthArray returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_Reference_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FunctionCallExpression_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_MessageParameter_9.current;
			afterParserOrEnumRuleCall();
		}
	)
;

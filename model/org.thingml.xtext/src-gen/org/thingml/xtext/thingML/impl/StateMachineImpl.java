 ...
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.StateMachineImpl#getInitial <em>Initial</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.StateMachineImpl#isHistory <em>History</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.StateMachineImpl#getSubstate <em>Substate</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.StateMachineImpl#getRegion <em>Region</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StateMachineImpl extends StateImpl implements StateMachine
{
  /**
    ...
    if (initial != null && initial.eIsProxy())
    {
      ...
      if (initial != oldInitial)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThingMLPackage.STATE_MACHINE__INITIAL, oldInitial, initial));
      }
    }
    return initial;
  }
  ...
  public void setInitial(State newInitial)
  {
    ...
    initial = newInitial;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.STATE_MACHINE__INITIAL, oldInitial, initial));
  }
  ...
  public void setHistory(boolean newHistory)
  {
    ...
    history = newHistory;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.STATE_MACHINE__HISTORY, oldHistory, history));
  }
  ...
  public EList<State> getSubstate()
  {
    if (substate == null)
    {
      substate = new EObjectContainmentEList<State>(State.class, this, ThingMLPackage.STATE_MACHINE__SUBSTATE);
    }
    return substate;
  }
  ...
  public EList<ParallelRegion> getRegion()
  {
    if (region == null)
    {
      region = new EObjectContainmentEList<ParallelRegion>(ParallelRegion.class, this, ThingMLPackage.STATE_MACHINE__REGION);
    }
    return region;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ThingMLPackage.STATE_MACHINE__SUBSTATE:
        return ((InternalEList<?>)getSubstate()).basicRemove(otherEnd, msgs);
      case ThingMLPackage.STATE_MACHINE__REGION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ThingMLPackage.STATE_MACHINE__INITIAL:
        if (resolve) return getInitial();
        return basicGetInitial();
      case ThingMLPackage.STATE_MACHINE__HISTORY:
        return isHistory();
      case ThingMLPackage.STATE_MACHINE__SUBSTATE:
        return getSubstate();
      case ThingMLPackage.STATE_MACHINE__REGION:

 ...
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.StateMachine#getInitial <em>Initial</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.StateMachine#isHistory <em>History</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.StateMachine#getSubstate <em>Substate</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.StateMachine#getRegion <em>Region</em>}</li>
 * </ul>
 *
 * @see org.thingml.xtext.thingML.ThingMLPackage#getStateMachine()
 * @model
 * @generated
 */
public interface StateMachine extends State
{
   ...
   * @see org.thingml.xtext.thingML.ThingMLPackage#getStateMachine_Initial()
   * @model
   * @generated
   */
  State getInitial();
  ...
  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.StateMachine#getInitial <em>Initial</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.thingml.xtext.thingML.ThingMLPackage#getStateMachine_History()
   * @model
   * @generated
   */
  boolean isHistory();
  ...
  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.StateMachine#isHistory <em>History</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.thingml.xtext.thingML.ThingMLPackage#getStateMachine_Substate()
   ...
   * @see org.thingml.xtext.thingML.ThingMLPackage#getStateMachine_Region()
   * @model containment="true"
   * @generated
   */

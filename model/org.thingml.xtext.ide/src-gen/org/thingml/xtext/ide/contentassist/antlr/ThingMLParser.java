		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEnumLiteralRefAccess().getEnumAssignment_1(), "rule__EnumLiteralRef__EnumAssignment_1");
					put(grammarAccess.getEnumLiteralRefAccess().getLiteralAssignment_3(), "rule__EnumLiteralRef__LiteralAssignment_3");

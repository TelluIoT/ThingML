		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getState_ImplAccess().getAlternatives_6(), "rule__State_Impl__Alternatives_6");
					put(grammarAccess.getCompositeState_ImplAccess().getAlternatives_10(), "rule__CompositeState_Impl__Alternatives_10");
					put(grammarAccess.getSessionAccess().getAlternatives_8(), "rule__Session__Alternatives_8");
					...
					put(grammarAccess.getState_ImplAccess().getGroup_5(), "rule__State_Impl__Group_5__0");
					...
					put(grammarAccess.getCompositeState_ImplAccess().getGroup_5(), "rule__CompositeState_Impl__Group_5__0");
					put(grammarAccess.getCompositeState_ImplAccess().getGroup_8(), "rule__CompositeState_Impl__Group_8__0");
					put(grammarAccess.getCompositeState_ImplAccess().getGroup_9(), "rule__CompositeState_Impl__Group_9__0");
					...
					put(grammarAccess.getSendActionAccess().getGroup_5(), "rule__SendAction__Group_5__0");
					...
					put(grammarAccess.getFunctionCallStatementAccess().getGroup_3(), "rule__FunctionCallStatement__Group_3__0");
					...
					put(grammarAccess.getThingMLModelAccess().getImportsAssignment_0_1(), "rule__ThingMLModel__ImportsAssignment_0_1");
					...
					put(grammarAccess.getFunctionAccess().getTypeAssignment_6_1(), "rule__Function__TypeAssignment_6_1");
					put(grammarAccess.getFunctionAccess().getAnnotationsAssignment_7(), "rule__Function__AnnotationsAssignment_7");
					put(grammarAccess.getFunctionAccess().getBodyAssignment_9(), "rule__Function__BodyAssignment_9");
					...
					put(grammarAccess.getPropertyAccess().getInitAssignment_4_1(), "rule__Property__InitAssignment_4_1");
					put(grammarAccess.getPropertyAccess().getAnnotationsAssignment_5(), "rule__Property__AnnotationsAssignment_5");
					...
					put(grammarAccess.getStateMachineAccess().getEntryAssignment_7_2(), "rule__StateMachine__EntryAssignment_7_2");
					put(grammarAccess.getStateMachineAccess().getExitAssignment_8_2(), "rule__StateMachine__ExitAssignment_8_2");
					put(grammarAccess.getStateMachineAccess().getPropertiesAssignment_9_0(), "rule__StateMachine__PropertiesAssignment_9_0");
					put(grammarAccess.getStateMachineAccess().getSubstateAssignment_9_1(), "rule__StateMachine__SubstateAssignment_9_1");
					put(grammarAccess.getStateMachineAccess().getInternalAssignment_9_2(), "rule__StateMachine__InternalAssignment_9_2");
					put(grammarAccess.getStateMachineAccess().getRegionAssignment_10(), "rule__StateMachine__RegionAssignment_10");
					put(grammarAccess.getState_ImplAccess().getNameAssignment_1(), "rule__State_Impl__NameAssignment_1");
					put(grammarAccess.getState_ImplAccess().getAnnotationsAssignment_2(), "rule__State_Impl__AnnotationsAssignment_2");
					put(grammarAccess.getState_ImplAccess().getEntryAssignment_4_2(), "rule__State_Impl__EntryAssignment_4_2");
					put(grammarAccess.getState_ImplAccess().getExitAssignment_5_2(), "rule__State_Impl__ExitAssignment_5_2");
					put(grammarAccess.getState_ImplAccess().getPropertiesAssignment_6_0(), "rule__State_Impl__PropertiesAssignment_6_0");
					put(grammarAccess.getState_ImplAccess().getInternalAssignment_6_1(), "rule__State_Impl__InternalAssignment_6_1");
					put(grammarAccess.getState_ImplAccess().getOutgoingAssignment_6_2(), "rule__State_Impl__OutgoingAssignment_6_2");
					...
					put(grammarAccess.getCompositeState_ImplAccess().getInitialAssignment_4(), "rule__CompositeState_Impl__InitialAssignment_4");
					put(grammarAccess.getCompositeState_ImplAccess().getHistoryAssignment_5_1(), "rule__CompositeState_Impl__HistoryAssignment_5_1");
					put(grammarAccess.getCompositeState_ImplAccess().getAnnotationsAssignment_6(), "rule__CompositeState_Impl__AnnotationsAssignment_6");
					put(grammarAccess.getCompositeState_ImplAccess().getEntryAssignment_8_2(), "rule__CompositeState_Impl__EntryAssignment_8_2");
					put(grammarAccess.getCompositeState_ImplAccess().getExitAssignment_9_2(), "rule__CompositeState_Impl__ExitAssignment_9_2");
					put(grammarAccess.getCompositeState_ImplAccess().getPropertiesAssignment_10_0(), "rule__CompositeState_Impl__PropertiesAssignment_10_0");
					put(grammarAccess.getCompositeState_ImplAccess().getSubstateAssignment_10_1(), "rule__CompositeState_Impl__SubstateAssignment_10_1");
					put(grammarAccess.getCompositeState_ImplAccess().getInternalAssignment_10_2(), "rule__CompositeState_Impl__InternalAssignment_10_2");
					put(grammarAccess.getCompositeState_ImplAccess().getOutgoingAssignment_10_3(), "rule__CompositeState_Impl__OutgoingAssignment_10_3");
					put(grammarAccess.getCompositeState_ImplAccess().getRegionAssignment_11(), "rule__CompositeState_Impl__RegionAssignment_11");
					put(grammarAccess.getSessionAccess().getNameAssignment_1(), "rule__Session__NameAssignment_1");
					put(grammarAccess.getSessionAccess().getInitialAssignment_3(), "rule__Session__InitialAssignment_3");
					put(grammarAccess.getSessionAccess().getAnnotationsAssignment_4(), "rule__Session__AnnotationsAssignment_4");
					put(grammarAccess.getSessionAccess().getEntryAssignment_6_2(), "rule__Session__EntryAssignment_6_2");
					put(grammarAccess.getSessionAccess().getExitAssignment_7_2(), "rule__Session__ExitAssignment_7_2");
					put(grammarAccess.getSessionAccess().getPropertiesAssignment_8_0(), "rule__Session__PropertiesAssignment_8_0");
					put(grammarAccess.getSessionAccess().getSubstateAssignment_8_1(), "rule__Session__SubstateAssignment_8_1");
					put(grammarAccess.getSessionAccess().getInternalAssignment_8_2(), "rule__Session__InternalAssignment_8_2");
					put(grammarAccess.getSessionAccess().getRegionAssignment_9(), "rule__Session__RegionAssignment_9");
					...
					put(grammarAccess.getReceiveMessageAccess().getPortAssignment_0(), "rule__ReceiveMessage__PortAssignment_0");
					put(grammarAccess.getReceiveMessageAccess().getMessageAssignment_2(), "rule__ReceiveMessage__MessageAssignment_2");
					...
					put(grammarAccess.getSendActionAccess().getParametersAssignment_4(), "rule__SendAction__ParametersAssignment_4");
					put(grammarAccess.getSendActionAccess().getParametersAssignment_5_1(), "rule__SendAction__ParametersAssignment_5_1");
					...
					put(grammarAccess.getStartSessionAccess().getConstructorAssignment_3(), "rule__StartSession__ConstructorAssignment_3");
					...
					put(grammarAccess.getFunctionCallStatementAccess().getParametersAssignment_2(), "rule__FunctionCallStatement__ParametersAssignment_2");
					put(grammarAccess.getFunctionCallStatementAccess().getParametersAssignment_3_1(), "rule__FunctionCallStatement__ParametersAssignment_3_1");

...
struct sockaddr_in /*PORT_NAME*/_si_local, /*PORT_NAME*/_si_remote;
...
int /*PORT_NAME*/_setup() {
    ...
    memset((char *) &/*PORT_NAME*/_si_remote, 0, sizeof(/*PORT_NAME*/_si_remote));
...
void /*PORT_NAME*/_start_receiver_process()
{
    ...
    while(1)
    {
        recv_len = recvfrom(/*PORT_NAME*/_socket, buf, /*PORT_NAME*/_BUFLEN, 0, (struct sockaddr *) &/*PORT_NAME*/_si_remote, sizeof(/*PORT_NAME*/_si_remote));
        if (recv_len < 0)
        {

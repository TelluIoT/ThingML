...
public class JavaTTYPlugin extends NetworkPlugin {

    public JavaTTYPlugin(AbstractThingMLValidator validator) {
        super(validator);
    }

    public String getPluginID() {
        return "JavaTTYPlugin";
    }
    ...
    private class SerialProtocol {
        ...
        public void generate() {
            ...
            String template = ctx.getTemplateByID("templates/JavaTTYPlugin.java");
            ...
            try {
                final File folder = new File(ctx.getOutputDirectory() + "/src/main/java/org/thingml/generated/network");
                folder.mkdir();
                final File f = new File(ctx.getOutputDirectory() + "/src/main/java/org/thingml/generated/network/StdIOJava.java");
                final OutputStream output = new FileOutputStream(f);
